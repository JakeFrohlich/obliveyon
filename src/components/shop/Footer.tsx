...
function MobileQuickLinks() {
  ...
  return (
    <div className="sm:hidden flex items-center justify-center gap-4 pt-10 pb-6">
      <Link
...
export default function Footer() {
  return (
    <footer className="w-full pt-20 pb-12" style={{ background: "#000000" }}>
      {/* Mobile-only quick links — sits just above the footer top divider */}
      <MobileQuickLinks />
      ...
      {/* Social icons (hidden on mobile — shown in MobileQuickLinks above) */}
      <div className="hidden sm:flex items-center justify-center gap-6 mb-10">
        <a
          href="https://discord.gg/M4kgbn9Z"
          target="_blank"
          rel="noopener noreferrer"
